...
{
    public partial class UserInfoParameter : GeneratedParameterDto<SupportingSpokaneChildren.Data.Auth.UserInfo>
    {
        ...
        /// </summary>
        public override void MapTo(SupportingSpokaneChildren.Data.Auth.UserInfo entity, IMappingContext context)
        {
        ...
        /// </summary>
        public override SupportingSpokaneChildren.Data.Auth.UserInfo MapToNew(IMappingContext context)
        {
            var includes = context.Includes;

            var entity = new SupportingSpokaneChildren.Data.Auth.UserInfo()
            {
                Roles = Roles,
    ...
    public partial class UserInfoResponse : GeneratedResponseDto<SupportingSpokaneChildren.Data.Auth.UserInfo>
    {
        ...
        /// </summary>
        public override void MapFrom(SupportingSpokaneChildren.Data.Auth.UserInfo obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
            var includes = context.Includes;
