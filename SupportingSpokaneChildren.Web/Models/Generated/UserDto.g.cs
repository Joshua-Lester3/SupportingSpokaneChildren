...
{
    public partial class UserParameter : GeneratedParameterDto<SupportingSpokaneChildren.Data.Models.User>
    {
        ...
        /// </summary>
        public override void MapTo(SupportingSpokaneChildren.Data.Models.User entity, IMappingContext context)
        {
        ...
        /// </summary>
        public override SupportingSpokaneChildren.Data.Models.User MapToNew(IMappingContext context)
        {
            var entity = new SupportingSpokaneChildren.Data.Models.User();
            MapTo(entity, context);
            return entity;
        }
    }

    public partial class UserResponse : GeneratedResponseDto<SupportingSpokaneChildren.Data.Models.User>
    {
        public UserResponse() { }
        ...
        public System.Collections.Generic.ICollection<SupportingSpokaneChildren.Web.Models.UserRoleResponse> UserRoles { get; set; }

        /// <summary>
        /// Map from the domain object to the properties of the current DTO instance.
        /// </summary>
        public override void MapFrom(SupportingSpokaneChildren.Data.Models.User obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
            var includes = context.Includes;
            ...
            if ((context.IsInRoleCached("UserAdmin")))
            {
                ...
                if (propValUserRoles != null && (tree == null || tree[nameof(this.UserRoles)] != null))
                {
                    this.UserRoles = propValUserRoles
                        ...
                        .Select(f => f.MapToDto<SupportingSpokaneChildren.Data.Models.UserRole, UserRoleResponse>(context, tree?[nameof(this.UserRoles)])).ToList();
                }
