...
namespace SupportingSpokaneChildren.Web.Api
{
    ...
    public partial class UserController
        : BaseApiController<SupportingSpokaneChildren.Data.Models.User, UserParameter, UserResponse, SupportingSpokaneChildren.Data.AppDbContext>
    {
        public UserController(CrudContext<SupportingSpokaneChildren.Data.AppDbContext> context) : base(context)
        {
            GeneratedForClassViewModel = context.ReflectionRepository.GetClassViewModel<SupportingSpokaneChildren.Data.Models.User>();
        }
        ...
        public virtual Task<ItemResult<UserResponse>> Get(
            ...
            IDataSource<SupportingSpokaneChildren.Data.Models.User> dataSource)
        ...
        public virtual Task<ItemResult<UserResponse>> Save(
            ...
            [FromQuery] DataSourceParameters parameters,
            IDataSource<SupportingSpokaneChildren.Data.Models.User> dataSource,
            IBehaviors<SupportingSpokaneChildren.Data.Models.User> behaviors)
            ...
            [FromQuery] byte[] etag)
        {
            ...
            var dataSource = dataSourceFactory.GetDataSource<SupportingSpokaneChildren.Data.Models.User, SupportingSpokaneChildren.Data.Models.User>("Default");
