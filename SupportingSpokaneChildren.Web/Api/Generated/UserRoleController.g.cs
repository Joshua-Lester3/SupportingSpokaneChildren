...
namespace SupportingSpokaneChildren.Web.Api
{
    ...
    public partial class UserRoleController
        : BaseApiController<SupportingSpokaneChildren.Data.Models.UserRole, UserRoleParameter, UserRoleResponse, SupportingSpokaneChildren.Data.AppDbContext>
    {
        public UserRoleController(CrudContext<SupportingSpokaneChildren.Data.AppDbContext> context) : base(context)
        {
            GeneratedForClassViewModel = context.ReflectionRepository.GetClassViewModel<SupportingSpokaneChildren.Data.Models.UserRole>();
        }
        ...
        public virtual Task<ItemResult<UserRoleResponse>> Get(
            ...
            IDataSource<SupportingSpokaneChildren.Data.Models.UserRole> dataSource)
        ...
        public virtual Task<ItemResult<UserRoleResponse>> Save(
            ...
            [FromQuery] DataSourceParameters parameters,
            IDataSource<SupportingSpokaneChildren.Data.Models.UserRole> dataSource,
            IBehaviors<SupportingSpokaneChildren.Data.Models.UserRole> behaviors)
